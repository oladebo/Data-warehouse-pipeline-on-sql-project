...
## Upload the CSV File Datawarehose pipeline project file to Postgres sql using python to insert data into the table database
...
engine = create_engine(
    "postgresql+psycopg2://postgres:postgres123@localhost:5432/DataWarehouse"

## let see the first postgress maybe it has coonect successfully
