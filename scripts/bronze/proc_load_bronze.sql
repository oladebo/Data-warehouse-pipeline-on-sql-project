/*
==========================================================================================================================
                                STORE PROCEDUE: Load Bronze Layer source Bronze
==========================================================================================================================
Scripts Purpose:
This store procedure load data into "bronze" layer schema from external CSV files and here is what he perfome as details:
- Dropping of bronze tables before its load data
- By using the python in Vscode + postgress sql server to load data of CSV files into schema bronze table
